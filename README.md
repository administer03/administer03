...
Hi there! I'm News, a Computer Science graduate from Chiang Mai University, currently pursuing a Master's degree in the same field. My passion lies in AI and Machine Learning, particularly in Reinforcement Learning, Machine Learning for Investment/Crypto Trading Bots, Sentiment Analysis, NLP, and Image Processing. I am also a Research Assistant at the National Astronomical Research Institute of Thailand (NARIT), where I classify images of astronomical objects and develop object detection algorithms for detecting globular clusters. My research on "Identification of Extragalactic Globular Clusters Using Machine Learning Techniques" was published in IEEE. My coding skills include Python, C/C++, Java, and R, and I have experience developing Android applications, such as the UNO game. I frequently use tools such as GitHub, Weka, Minitab, PyTorch, Keras, Scikit-learn, and Pandas. In terms of competitions, I have participated in various AI-related events, including: 
